      ...
      <nav style={{
        ...
        >
          ...
          {isLiteratureReviewDropdownOpen && (
            <div style={{
              ...
              <a href="literature-review.html" style={styles.dropdownLink} target="_blank" rel="noopener noreferrer" onMouseOver={e => e.currentTarget.style.backgroundColor=styles.dropdownLinkHover.backgroundColor} onMouseOut={e => e.currentTarget.style.backgroundColor='transparent'}>Detailed Literature Review Page</a>
            </div>
          )}
        </div>
        ...
        >
          ...
          {isFindingsOpen && (
            <div style={{
              ...
              <a href="findings.html" style={styles.dropdownLink} target="_blank" rel="noopener noreferrer" onMouseOver={e => e.currentTarget.style.backgroundColor=styles.dropdownLinkHover.backgroundColor} onMouseOut={e => e.currentTarget.style.backgroundColor='transparent'}>Detailed Findings Page</a>
            </div>
          )}
        </div>
        ...
        >
          <a href="case-studies.html" style={{
            ...
            transition: 'all 0.3s ease',
          }} target="_blank" rel="noopener noreferrer">Case Studies</a>
          {isCaseStudiesDropdownOpen && (
            <div style={{
              ...
              <a href="case-studies.html" style={styles.dropdownLink} target="_blank" rel="noopener noreferrer" onMouseOver={e => e.currentTarget.style.backgroundColor=styles.dropdownLinkHover.backgroundColor} onMouseOut={e => e.currentTarget.style.backgroundColor='transparent'}>Detailed Case Studies Page</a>
            </div>
          )}
        </div>
